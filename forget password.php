...
#highlighted .container-fluid p {re
  color: #fff;
}
#highlighted .container-fluid h1 {
  font-size: 54px;
...
<div id="highlighted" class="hl-basic hidden-xs py-4">
...
<div id="highlighted" class="hl-basic hidden-xs py-5">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 col-lg-10 col-lg-offset-2">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-sm-3 col-md-3 col-lg-2 sidebar equal-height interior-page-nav hidden-xs">
        <div class="dynamicDiv panel-group" >
      ...
      <!--Content-->
      <div class="col-sm-9 col-md-9 col-lg-10 content py-4 ">
        <div class="content-area-right">
          <div class="content-crumb-div">
            <a href="index.php">Home</a> | <a href="login.php">Your Account</a> | Forgot Password
          </div>
